...
import { getCurrentCRC, MATCHMAKING_CRC, UpdateCrc } from "../../data/config";
...
async function generateGameConfig_hiss() {
  return {
    Crc: getCurrentCRC(),
    ...
    Data: {
      ...
      "feature-toggles": {
        _hydra_compressed: {
          ...
          evtq_arena: true,
          evtq_1v1testinggrounds: true,
          evtq_2v2testinggrounds: true,
        },
      },
...
async function syncAsset(dto: SYNC_ASSET) {
...
export const GameConfigService = { generateGameConfig_hiss, syncAsset };
