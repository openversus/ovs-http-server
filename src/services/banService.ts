...
export function isIPInCIDRBlock(ipAddress: string, cidrBlock: string): boolean {
  const [block, prefixLength] = cidrBlock.split('/');
...
export function banIP(ipAddress: string, playerID: string = "Not Provided", oldName: string = "Not Provided", newName: string = "Not Provided", reason?: string): void {
